...
Static personal academic homepage for Yiting Hu. It is inspired by the clean
academic style of GitHub templates such as al-folio, Academic Pages, and Hugo
Blox Academic CV, but it has no build step and can be deployed directly on
GitHub Pages.

Live URL: https://yitinghu011.github.io/
